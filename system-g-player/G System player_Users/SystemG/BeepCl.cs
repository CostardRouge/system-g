...
namespace SystemG
{
    public class BeepCl
    {
        ...
        // constructor
        public BeepCl(IntPtr f)
        {
            CreatePlayBuffer(f);

            NextWriteOffset = 0;

            for (int i = 0; i < PlaybackData.Length; i++)  PlaybackData[i] = 0; // hi/low byte = 0
...
//            buffa.Play(0, BufferPlayFlags.Default);
        ...
        void SetVolume(System.Int32 vol)
        {
            ...
            {
              //  MessageBox.Show(null, "Error: volume out of range", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        void SetDuration(System.Int32 dur)
        {
            if (dur >= 20)
                osc.duration = dur;
            //else
               // MessageBox.Show(null, "Error: duration out of range", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        void SetFrequency(double freq)
        {
            ...
            //else
              //  MessageBox.Show(null, "Error: frequency out of range", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
        ...
        /////////////////////////////////////////////////////
        void CreatePlayBuffer(IntPtr f)
        {
            ...
            {
                //MessageBox.Show(null, "Error creating sound device", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            dsDevice.SetCooperativeLevel(f, CooperativeLevel.Priority);
